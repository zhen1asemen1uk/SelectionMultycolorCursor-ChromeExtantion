...
radio_colorMode.forEach((button)=>{
    if (button.checked) changeColorMode(button.value);
...
function changeColorMode(mod) {
    switch(mod){
        case "lsd":
            ...
            document.addEventListener("selectionchange", ()=>changeColors(mod)
            );
            break;
        case "randomOne":
            removeAllEventListeners();
...
function removeAllEventListeners() {
    ...
    if (styleSheet.cssRules.length > 0) for(let i = 0; i < styleSheet.cssRules.length; i++)styleSheet.deleteRule(i);
}
//mode functions
...
},{}]},["kn9T2","7fmqN","8lqZg"], "8lqZg", "parcelRequired196")
