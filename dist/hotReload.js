...
})({"cOy4p":[function(require,module,exports) {
var _crxHotreload = require("crx-hotreload");

},{"crx-hotreload":"gi6sp"}],"gi6sp":[function(require,module,exports) {
var _helpers = require("@swc/helpers");
var _instance;
var filesInDirectory = function(dir) {
    return new Promise(function(resolve1) {
        return dir.createReader().readEntries(function(entries) {
            return Promise.all(entries.filter(function(e) {
                ...
                return (_instance = []).concat.apply(_instance, _helpers.toConsumableArray(files));
            }).then(resolve1);
        });
    });
};
var timestampForFilesInDirectory = function(dir) {
...
var watchChanges = function(dir, lastTimestamp) {
    timestampForFilesInDirectory(dir).then(function(timestamp) {
        if (!lastTimestamp || lastTimestamp === timestamp) setTimeout(function() {
...
},{"./_construct":"b5NGZ","./_is_native_function":"lAf9K","./_get_prototype_of":"900T7","./_set_prototype_of":"2765R","@parcel/transformer-js/src/esmodule-helpers.js":"5ITdS"}],"9INtN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5ITdS"}]},["cOy4p"], "cOy4p", "parcelRequire8a8c")
